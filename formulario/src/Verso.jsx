    ...
    <div className="h-screen w-screen bg-slate-400 flex justify-center items-center flex-row">
      ...
      <div className="bg-white shadow-md border border-gray-300">
        <div className="w-[297mm] h-[210mm] flex justify-center items-center">
                ...
                <div className="flex flex-col justify-center mt-5 w-[50em] h-[5em] rounded-md border-[1.5px] border-black">
                  <div className="border-b-[1.5px] border-black py-2">
                    <div className="flex justify-between">
                      <CampoForm
                        ...
                        width={"5em"}
                      />
                      <CampoForm id={"sexo"} content={"SEXO:"} width={"5em"} />
                      <CampoForm
                        id={"altura"}
                        content={"ALTURA:"}
                        width={"5em"}
                      />
                      <CampoForm id={"peso"} content={"PESO:"} width={"5em"} />
                      <CampoForm id={"lado"} content={"LADO:"} width={"5em"} />
                    </div>
                  </div>
                  <div className="py-2 flex justify-between">
                    ...
                    <CampoForm
                      ...
                      width={"15em"}
                    />
                    <CampoForm id={"tempo"} content={"TEMPO:"} width={"6em"} />
                  </div>
                </div>
              </div>
              {/* BASE DO FORMULÁRIO */}
          ...
          <div className="absolute mt-24 right-[35em] w-[30em] h-[40em]">
            <img
              src="/Perna.png"
              alt="Desenho de uma perna com medidas"
              className="w-[28em] h-[38em]"
            />
          </div>
        </div>
      </div>
